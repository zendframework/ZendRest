 ...
 * @subpackage Client
 */
class XMLResult implements ResultInterface, IteratorAggregate
{
     ...
     *
     * @param string $name
     * @return null SimpleXMLElement array not found, SimpleXMLElement if only one value found, array of \ZendRest\Client\XMLResult objects otherwise
     */
     ...
     * Convert to array
     *
     * @see \ZendRest\Client\ResultInterface::toArray()
     * @return array
     */
    public function toArray()
    {
        return Json::decode(Json::encode($this->getIterator(), true), Json::TYPE_ARRAY);
    }
}
